      ...
      <div className="w-[90vw] flex items-center justify-between  p-10 rounded-2xl">
        <div className="w-[25vw]">
          ...
          {products1.map((item, index) => (
            <div key={index} className="mt-10 items-center flex gap-5">
              <div className="border-[2px] flex items-center justify-center rounded-[5px] border-[#48484829] w-[30%] bg-white">
                <Image
